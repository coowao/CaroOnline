...
public class MainMenu extends javax.swing.JFrame {
    ...
    public MainMenu() {
        ...
        // add double-click to join room
        tbListRoom.addMouseListener(new java.awt.event.MouseAdapter() {
    ...
    private void joinSelectedRoom() {
        ...
        if (row >= 0) {
            ...
            RunClient.socketHandler.joinRoom(roomId);
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "Vui lòng chọn phòng trước khi vào.", "Lỗi", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
